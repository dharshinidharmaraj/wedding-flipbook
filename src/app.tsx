...
function App() {
  ...
  return (
    ...
    <div style={mainWrapper}>
      ...
      {/* UI Overlay remains unaffected by the white pages */}
      ...
      {/* Navigation arrows will sit over the white pages */}
      ...
      <div style={{ display: "flex", width: "100%", height: "100%", alignItems: "center", justifyContent: "center" }}>
        ...
        >
          ...
          {/* COVER - Background color now white via the fullPage style */}
          ...
          {/* IMAGE PAGES (ZOOM ONLY HERE) - Background is white via fullPage */}
          ...
          {/* END PAGE - Background now white, text color updated */}

          <div style={endPageStyle}>

            <h2 style={{ color: "#000" }}>Forever</h2> {/* Changed color for visibility */}
...
const mainWrapper: React.CSSProperties = {
  ...
  background: "#ffffffff", // Outer background remains black for contrast
...
const fullPage: React.CSSProperties = {
  ...
  background: "#fff", // Pages background is now white
...
const navBtn = {
  ...
  background: "rgba(0, 0, 0, 0.3)", // Darker nav background for visibility against white pages
...
const endPageStyle: React.CSSProperties = {
  ...
  background: "#fff", // End page background also updated to white
